...
function prepareReview() {
  ...
  const _fileUploadHtml = attachedFile ? `<div class="review-section"><div class="review-section-title">・ไฟล์แนบ</div><div style="padding:10px 14px;background:#f5f5f5;border-radius:8px;display:flex;align-items:center;gap:10px;"><i class="fas fa-file-alt" style="color:#2d6a4f;font-size:1.1rem;"></i><div><div style="font-size:.87rem;font-weight:600;color:#333;word-break:break-all;">${attachedFile.name}</div><div style="font-size:.78rem;color:#888;margin-top:2px;">${(attachedFile.size/1024/1024).toFixed(2)} MB</div></div></div></div>` : '';
